...
public class ArithmeticExpression implements IExpression {
    ...
    public ArithmeticExpression(Character _op, IExpression _exp1, IExpression _exp2) throws ExpressionException {
        if(_op.equals('+')) {
            op = 1;
        }
        else
            if(_op.equals('-')) {
                ...
                if(_op.equals('*')) {
                    ...
                    if(_op.equals('/')) {
                        ...
                        throw new ExpressionException("the operator " + _op + "is invalid.\n");
